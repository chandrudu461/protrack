...
// This is the profile Activity, in this we'll take details from user and we'll store it in realtime database.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() { // If we click the submit, we'll upload the image to firebaseStorage
            ...
            public void onClick(View view) {
                ...
                firebaseUtilities.uploadImage(selectedImageUri); // Uploading the image
                sendDataToDatabase();  //  Sends the data to realtime database
                startActivity(new Intent(ProfileActivity.this,RetrieveData.class));
            }
        });
